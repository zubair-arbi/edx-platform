...
urlpatterns = ('',
    ...
    url(r'^get_source/(?P<module_location>.*?)$', 'contentstore.views.get_module_source_metadata', name='get_source'),
    url(r'^put_source/(?P<module_location>.*?)$', 'contentstore.views.save_module_source_metadata', name='put_source'),
    url(r'^put_source_images/(?P<module_location>.*?)$', 'contentstore.views.save_module_source_images', name='put_source_images'),
