...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('auth_userprofile', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'UserProfile.courseware'
        db.alter_column('auth_userprofile', 'courseware', self.gf('django.db.models.fields.CharField')(max_length=200))
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'courseware': ('django.db.models.fields.CharField', [], {'default': "'course.xml'", 'max_length': '200', 'blank': 'True'}),
