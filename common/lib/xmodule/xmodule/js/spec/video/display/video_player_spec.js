...
(function() {
  describe('VideoPlayer', function() {
    beforeEach(function() {
      ...
      _ref = ['VideoCaption', 'VideoSpeedControl', 'VideoVolumeControl', 'VideoProgressSlider', 'VideoControl'];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        part = _ref[_i];
        spyOn(window[part].prototype, 'initialize').andCallThrough();
      }
      return jasmine.stubVideoPlayer(this, [], false);
    });
    afterEach(function() {
    ...
    describe('constructor', function() {
      ...
      describe('always', function() {
        ...
        it('bind to video caption seek event', function() {
          return expect($(this.player.caption)).toHandleWith('seek', this.player.onSeek);
        });
        ...
        it('bind to video progress slider seek event', function() {
          return expect($(this.player.progressSlider)).toHandleWith('seek', this.player.onSeek);
        });
    ...
    describe('onStateChange', function() {
      ...
      describe('when the video is unstarted', function() {
        beforeEach(function() {
          ...
          this.player.caption.pause = jasmine.createSpy('VideoCaption.pause');
      ...
      describe('when the video is playing', function() {
        beforeEach(function() {
          ...
          this.player.caption.play = jasmine.createSpy('VideoCaption.play');
          this.player.progressSlider.play = jasmine.createSpy('VideoProgressSlider.play');
    ...
    describe('updatePlayTime', function() {
      beforeEach(function() {
        ...
        this.player.caption.updatePlayTime = jasmine.createSpy('VideoCaption.updatePlayTime');
        this.player.progressSlider.updatePlayTime = jasmine.createSpy('VideoProgressSlider.updatePlayTime');
    ...
    describe('toggleFullScreen', function() {
      beforeEach(function() {
        ...
        return this.player.caption.resize = jasmine.createSpy('VideoCaption.resize');
      });
