...
###############################################################################
#
#class GetCourseTabsTestCase(TestCase):
#
#   def setUp(self):
#
#      self.user = MagicMock()
...
#      self.course.tabs = [{'type':'courseware'}]
#
#   def test_get_course_tabs(self):
#
#      self.assertEqual(tabs.get_course_tabs(self.user, self.course0, self.active_page), tabs.get_default_tabs(self.user, self.course0, self.active_page))
#      
###############################################################################
