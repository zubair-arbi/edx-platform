...
class CommandsXMLTestCase(CommandsBase, ModuleStoreTestCase):
    """
    Test case for management commands

    Uses the xml modulestore.
    """


@override_settings(MODULESTORE=TEST_DATA_MONGO_MODULESTORE)
class CommandsMongoTestCase(CommandsBase, ModuleStoreTestCase):
    """
    Test case for management commands

    Uses the mongo modulestore.
    """


@override_settings(MODULESTORE=TEST_DATA_MIXED_MODULESTORE)
class CommandsMixedTestCase(CommandsBase, ModuleStoreTestCase):
    """
    Test case for management commands

    Uses the mixed modulestore.
    """
