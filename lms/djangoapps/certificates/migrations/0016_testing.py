...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('certificates_generatedcertificate', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Deleting field 'CertificateWhitelist.dummyfield'
        db.delete_column('certificates_certificatewhitelist', 'dummyfield')

        # Adding field 'CertificateWhitelist.whitelist2'
        db.add_column('certificates_certificatewhitelist', 'whitelist2',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'CertificateWhitelist.course_id'
        db.alter_column('certificates_certificatewhitelist', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'GeneratedCertificate.course_id'
        db.alter_column('certificates_generatedcertificate', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Adding field 'CertificateWhitelist.dummyfield'
        db.add_column('certificates_certificatewhitelist', 'dummyfield',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'CertificateWhitelist.whitelist2'
        db.delete_column('certificates_certificatewhitelist', 'whitelist2')


        # Changing field 'CertificateWhitelist.course_id'
        db.alter_column('certificates_certificatewhitelist', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'certificates.certificatewhitelist': {
            ...
            'course_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'whitelist': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'whitelist2': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
