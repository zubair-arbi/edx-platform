...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'certificates.certificatewhitelist': {
            ...
            'course_id': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'dummyfield': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
